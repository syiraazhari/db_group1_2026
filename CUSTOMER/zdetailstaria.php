      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url(images/staria.jpg);"></div>
      				<div class="text text-center">
      					<span class="subheading">Hyundai</span>
      					<h2>Hyundai Staria</h2>
      				</div>
      			</div>
      		</div>
      	</div>
						...
						<div class="bd-example bd-example-tabs">
						  ...
						  <div class="tab-content" id="pills-tabContent">
						    ...
						    <div class="tab-pane fade" id="pills-manufacturer" role="tabpanel" aria-labelledby="pills-manufacturer-tab">
						      <p>The Hyundai Staria is a striking, futuristic multi-purpose vehicle designed to transport you in absolute luxury. Blending a spaceship-inspired exterior with a massive, lounge-like cabin, it offers incredible headroom and large panoramic windows for an airy driving experience. Powered by a highly efficient 2.2L turbodiesel engine and packed with smart safety features, the Staria is the ultimate choice for executive travel, premium tours, and large family road trips.</p>
						    </div>
						      ...
						      <div class="row">
							   		<div class="col-md-7">
							   			...
							   			<div class="review d-flex">
									   		...
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Faizal Zahir</span>
									   				<span class="text-right">18 December 2023</span>
									   			</h4>
									   			<p class="star">
									   				<span>
									   			...
									   			<p>Kereta memang selesa and best  untuk family ramai</p>
									   		</div>
									   	</div>
									   	<div class="review d-flex">
									   		...
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Mohd Irfan</span>
									   				<span class="text-right">11 April 2021</span>
									   			</h4>
									   			<p class="star">
									   				<span>
									   					<i class="ion-ios-star"></i>
									   			...
									   			<p>Kereta in good condition sangat bersih dan sesuai untuk long family trip</p>
									   		</div>
									   	</div>
									   	<div class="review d-flex">
									   		...
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Aiman Fakir</span>
									   				<span class="text-right">20 October 2022</span>
									   			</h4>
									   			<p class="star">
									   				<span>
									   					<i class="ion-ios-star"></i>
